...
pi install "npm:pi-token-speed" >nul 2>&1 || echo   (Skipped - install manually)
echo   Installing pi-dynamic-workflows ...
pi install "npm:@quintinshaw/pi-dynamic-workflows" >nul 2>&1 || echo   (Skipped - install manually)
...
echo   Installing pi-local-rag ...
pi install "npm:pi-local-rag" >nul 2>&1 || echo   (Skipped - install manually)
echo   Installing piolium ...
pi install "npm:@vigolium/piolium" >nul 2>&1 || echo   (Skipped - install manually)
